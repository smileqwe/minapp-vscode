...
export function activate(context: ExtensionContext): void {
  ...
  const linkProvider = new LinkProvider(config) // 文档链接提供者，支持 src 等属性路径的 Ctrl+Click 跳转
  ...
  context.subscriptions.push(
    ...
    // 注册文档链接提供者：支持 src 等属性路径的 Ctrl+Click 跳转到目标文件
    languages.registerDocumentLinkProvider(wxml, linkProvider),
